...
namespace TacticalHeroes.Admin.Modules.Compendium.ComponentTests.Pages.CreateHeroPage.Model;

public sealed class CreateHeroFormModelValidatorTests
{
    ...
    {
        var validator = new CreateHeroFormModelValidator();

        var result = validator.Validate(new CreateHeroFormModel());
    ...
    {
        var model = new CreateHeroFormModel
        {
