...
namespace TacticalHeroes.Admin.Modules.Compendium.ComponentTests.Pages.CreateUnitPage.Model;

public sealed class CreateUnitFormModelValidatorTests
{
    ...
    {
        var model = new CreateUnitFormModel
        {
            Name = "Archer",
        ...
        var validator = new CreateUnitFormModelValidator();
    ...
    public void Validate_Should_RequireTextAndFaction_When_ModelIsEmpty()
    {
        ...
        var result = validator.Validate(new CreateUnitFormModel());
