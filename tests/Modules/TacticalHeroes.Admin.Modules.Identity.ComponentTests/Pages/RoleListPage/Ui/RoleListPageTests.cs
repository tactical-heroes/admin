...
public sealed class RoleListPageTests : BunitContext
{
    ...
    [Fact(DisplayName = "DeleteRoleAsync should delete and reload when deletion is confirmed")]
    ...
    {
        Services.GetRequiredService<NavigationManager>().NavigateTo(
            IdentityRoutes.Roles + "?page=2&pageSize=25&sort=Name%3Adesc&sort=Id%3Aasc");
